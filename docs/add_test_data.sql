...
START TRANSACTION;
USE `oobbit`;
INSERT INTO `oobbit`.`categories` (`id`, `title`, `description`) VALUES (1, 'Cat pictures', 'Pictures of cats!');
INSERT INTO `oobbit`.`categories` (`id`, `title`, `description`) VALUES (2, 'Funny pictures', 'Pictures of funny!');
COMMIT;

START TRANSACTION;
USE `oobbit`;
INSERT INTO `oobbit`.`links` (`id`, `title`, `content`, `link`, `category`, `creator`, `create_time`, `edit_time`) VALUES (1, 'Pssst... Hey, You Guys Wanna Buy a Cat?', 'Cat in a box', 'https://i.imgur.com/6LCNnDm.jpg', 1, 24, 'NOW()', NULL);
INSERT INTO `oobbit`.`links` (`id`, `title`, `content`, `link`, `category`, `creator`, `create_time`, `edit_time`) VALUES (2, 'Heart nose', 'A cat has a LOVELY nose, haha. Get it?', 'https://i.imgur.com/I4vJzFY.jpg', 1, 26, 'NOW()', NULL);
COMMIT;
